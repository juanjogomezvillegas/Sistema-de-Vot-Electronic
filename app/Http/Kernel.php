...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'allowElection' => \App\Http\Middleware\AllowElection::class,
        'allowResult' => \App\Http\Middleware\AllowResult::class,
        'allowPactometer' => \App\Http\Middleware\AllowPactometer::class,
        'allowLegislatures' => \App\Http\Middleware\AllowLegislatures::class,
